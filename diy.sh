...
#修改wifi信息
sed -i 's/OpenWrt/qwerts/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
sed -i 's/none/psk2/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
sed -i '/psk2/a\set wireless.default_radio${devidx}.key='pikapika1987.'' package/kernel/mac80211/files/lib/wifi/mac80211.sh
